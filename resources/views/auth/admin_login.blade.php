							...
							<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" value="admin@gmail.com" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email Address">
									</div>
                                    @error('email')
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" value="78957895" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
                                    @error('password')
                                    <span class="invalid-feedback">
                                        {{ $message }}
