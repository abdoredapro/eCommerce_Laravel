                      ...
                      <div class="accordion-body collapse" id="collapse{{ $category->id}}" style="height: 0px;">
                        <div class="accordion-inner">
                          ...
                          <ul>
                            ...
                            <li><a href="{{ route('show.product.subCategory',['id'=>$sub->id, 'sub_slug'=>$sub->subCategory_slug_en]) }}">{{$sub->subCategory_name_en}}</a></li>
                            @endforeach
                          </ul>
                        </div>
                        <!-- /.accordion-inner --> 
                      ...
                      <div class="products">
                        <div class="product">
                          <div class="product-image">
                            <div class="image"> <a href="{{route('product.detail',['id'=>$product->id,'slug'=>$product->product_slug_en])}}"><img  src="{{ asset('upload/product/'.$product->product_thambnail) }}" alt=""></a> </div>
                            <!-- /.image -->
                      ...
                      <div class="product-list product">
                        <div class="row product-list-row">
                          <div class="col col-sm-4 col-lg-4">
                            <div class="product-image">
                              <div class="image"> <img src="{{ asset('upload/product/'.$product->product_thambnail) }}" alt=""> </div>
                            </div>
                            <!-- /.product-image --> 
                          </div>
                          <!-- /.col -->
                          <div class="col col-sm-8 col-lg-8">
                            <div class="product-info">
                              ...
                              <div class="product-price"> <span class="price">${{ $product->selling_price }}</span> <span class="price-before-discount">$ 800</span> </div>
                              <!-- /.product-price -->
                              <div class="description m-t-10">{!! $product->long_des_en !!}</div>
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
                                    <li class="add-cart-button btn-group">
                                      <button  id='{{$product->id}}' 
                                        data-toggle="modal" data-target="#exampleModal" onclick="getProduct(this.id)"
                                        class="btn btn-primary icon" type="button" title="Add Cart"> <i class="fa fa-shopping-cart"></i> </button>
                                      <button class="btn btn-primary cart-btn" id='{{$product->id}}' 
                                        data-toggle="modal" data-target="#exampleModal" onclick="getProduct(this.id)"
                                          type="button">Add to cart</button>
                                    </li>
                                    {{-- <li class="lnk wishlist ">  --}}
