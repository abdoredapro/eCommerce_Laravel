  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>El Nemr</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
                El Nemr Head Office
               Email:elnemr@support.com <br>
               Mob: 01014318965 <br>
               Cairo, Tanta 4121 <br>
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           {{ $order->Division->division_name }},{{ $order->district->district_name }}, {{ $order->state->state_name }} 
           <br>
...
<h3>Products</h3>
  ...
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        <td align="center">
            <img src="{{ public_path('upload/product/'.$item->Product->product_thambnail) }}" height="60px;" width="60px;" alt="">
        </td>
  ...
  <div class="authority float-right mt-5">
      <p>-----------------------------------</p>
      <h5>Authority Signature: Elnemr</h5>
    </div>
</body>
</html>